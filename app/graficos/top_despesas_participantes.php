...
<div class="pageheader">
	<h2><i class="glyphicon glyphicon-signal"></i> Gráficos<span>maiores despesas por participantes</span></h2>
	<div class="breadcrumb-wrapper">
		<span class="label">Você está em:</span>
		<ol class="breadcrumb">
		  <a href="top_despesas_participantes">Maiores despesas por participantes</a>
		</ol>

	</div>
</div>
<input type="hidden" id="codigo_instrucao" value="MAIORES_DESPESAS_PARTICIPANTES">
<div class="contentpanel">
    ...
    <div class="row">
    	<div class="panel panel-default">
			<div class="panel-heading">
			  	...
			  	<h4 class="panel-title">Maiores despesas por participantes (Valores em R$)</h4>
			</div>
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-9 col-sm-12">
						<div style="height:300px;width:100%" id="top_gastos_participantes"></div>
						<p>**Clique no participante do gráfico para visualizar detalhes.</p>
					...
					<div id="graf_det" class="col-md-3 col-sm-12">
						<!--<table id="table_graf" class="col-sm-12 col-md-12 table_graf hide">
							<thead>
								<tr>
									<th class="th_graf">Participante</th>
    ...
    <div class="modal fade" id="detalhesParticipantesModal" tabindex="-1" role="dialog" aria-labelledby="detalhesParticipantesModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="detalhesParticipantesModalLabel"></h4>
			  </div>
...
<?php
	$scripts='<script type="text/javascript" src="../scripts/graficos/top_despesas_participantes.js"></script>
