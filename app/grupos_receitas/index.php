...
<div class="pageheader">
	<h2><i class="fa  fa-file-text-o"></i> Grupos de receitas<span>cadastrados</span></h2>
	<div class="breadcrumb-wrapper">
		<span class="label">Você está em:</span>
		<ol class="breadcrumb">
		  <a href="index">Grupos de receitas</a>
		</ol>

	</div>
</div>
<input type="hidden" id="codigo_instrucao" value="GRUPOS_RECEITAS_INSTRUCAO">
    ...
    <div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">
			  	...
			  	<h4 class="panel-title">Grupos de receitas</h4>
			</div>
...
<?php 
	$scripts='<script type="text/javascript" src="../scripts/grupo_receitas/validacao.js"></script>
